        ...
        binding.apply {
            ...
            checkBtn.setOnClickListener {
                    ...
                    if (toggleButton.isChecked) {
                        if (ScheduleName.text.isNotEmpty() && startDateBtn1.text.isNotEmpty() &&
                            ...
                            CoroutineScope(Dispatchers.Main).launch {
                                ...
                                var intent =
                                    Intent(this@AddSchedule, CheckRegisterActivity::class.java)
                                startActivity(intent)
                                clearVar()
                                clearAllBtn()
                                finish()
                ...
                startDate.setOnClickListener {
                    val c: java.util.Calendar =
                        java.util.Calendar.getInstance() // Calendar 객체로 날짜 얻어오기
                ...
                LocationAddr.setOnClickListener {
                    ...
                    val intent =
                        Intent(
                            this@AddSchedule,
                            ProgrammaticAutocompleteGeocodingActivity::class.java
                        )
                        ...
                        for (user2 in check_msgUser) {
                            if (user!!.user_email.compareTo(user2) == 0) {
                                CoroutineScope(Dispatchers.IO).launch {
                                    // 메시지 생성
                                    Log.i(
                                        "checkBindingsschedulename",
                                        binding.ScheduleName.text.toString()
                                    )
                                    Log.i(
                                        "checkBindingstartdatebtn1",
                                        binding.startDateBtn1.text.toString()
                                    )
                                    Log.i(
                                        "checkBindingstartdatebtn2",
                                        binding.startDateBtn2.text.toString()
                                    )
                                    val message = """
        {
            "to": "${user.user_token}",
